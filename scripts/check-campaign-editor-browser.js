...
(async () => {
  ...
  await set('title','');
  await click('Oluştur ve web sitesinde yayınla');
  ...
  const draft = button('Web sitesinde göstermeden oluştur'); draft.click(); draft.click();
  ...
  return 'PASS: required fields, 3→4 transition, implicit submit, hidden-field validation, double click, hidden/visible website choices and reopen. No real records created.';
})()
