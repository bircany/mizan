...
const campaigns: Campaign[] = [
  {
    ...
    category: "Su Kuyusu",
    image: "/images/donations/kurban-dagitimi.png",
    progress: 72,
    target: 45000,
    donors: 1248,
  ...
  },
  {
    ...
    category: "Yetim",
    image: "/images/donations/mescid-imar.png",
    progress: 45,
    target: 25000,
    donors: 856,
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-[140px] space-y-md">
              ...
              <div className="bg-surface-container-lowest p-md rounded-xl border border-surface-container space-y-4">
                <div className="flex items-center justify-between gap-3 rounded-lg border border-outline-variant/50 bg-surface p-3">
                  <span className="text-label-sm font-semibold text-on-surface-variant">Güvenli ödeme altyapısı</span>
                  <Image
