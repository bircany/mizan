    ...
    <div dir={dir}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <span className="material-symbols-outlined text-[32px] text-gold">volunteer_activism</span>
                <div>
              ...
              <div className="flex items-center gap-3 text-white/80 mt-4">
                <span className="material-symbols-outlined text-gold">phone_in_talk</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
            {campaigns.map((campaign, i) => (
              <div key={i} className="relative group/card">
                <div className="absolute -inset-x-6 -inset-y-10 rounded-[40px] bg-[radial-gradient(circle,rgba(0,170,40,.18)_0%,rgba(0,170,40,.08)_45%,transparent_75%)] opacity-0 group-hover/card:opacity-100 blur-3xl transition-opacity duration-500 pointer-events-none z-0" />
                <div
      ...
      <section className="pt-10 lg:pt-16 pb-20 lg:pb-28 bg-white relative">
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <div className="text-center mb-10">
            <h2 className="text-5xl font-bold whitespace-nowrap max-w-none text-center text-on-surface">
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <div className="relative rounded-3xl overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.08)]">
                <img
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-lg text-on-surface/75 italic leading-relaxed mb-8 max-w-lg mx-auto">
                  "{stories[activeTestimonial].quote}"
                </p>
      ...
      <Link
        href="/bagis"
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 bg-secondary text-white p-4 rounded-full shadow-lg flex items-center justify-center hover:shadow-xl hover:scale-110 hover:-translate-y-1 transition-all duration-300 group z-[100]"
      >
