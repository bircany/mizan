...
export async function GET(
  ...
  try {
      ...
      [
        payload.findByID({
          ...
          select: {
            ...
            status: true,
            dispatchState: true,
            dispatchPauseReason: true,
            testMessagePassedAt: true,
          },
          populate: {
            campaigns: { title: true, code: true },
          },
          overrideAccess: true,
        }),
        payload.find({
        ...
        payload.find({
          ...
          populate: {
            ...
            "donation-intents": { donorName: true, phone: true },
          },
          overrideAccess: true,
        }),
      ],
    ...
    console.error("[delivery-detail] operation query failed", {
      groupId,
